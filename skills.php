<div class="skills" id="skills">
	<div class="container">
				<h3 data-aos="zoom-in">Conocimientos</h3>
		<div class="skill-grids">
			...
			<div class="skillbar clearfix " data-percent="70%">
				<div class="skillbar-title" style="background: #ff9900;"><span>Laravel</span></div>
				<div class="skillbar-bar" style="background: #ff9900;"></div>
				<div class="skill-bar-percent">70%</div>
			</div> <!-- End Skill Bar -->

			<div class="skillbar clearfix " data-percent="60%">
				<div class="skillbar-title" style="background: #8e43e7;"><span>C/C++</span></div>
				<div class="skillbar-bar" style="background: #8e43e7;"></div>
				<div class="skill-bar-percent">60%</div>
			</div> <!-- End Skill Bar -->

			<div class="skillbar clearfix " data-percent="50%">
				<div class="skillbar-title" style="background: #146eb4;"><span>Angular</span></div>
				<div class="skillbar-bar" style="background: #146eb4;"></div>
				<div class="skill-bar-percent">50%</div>
			</div> <!-- End Skill Bar -->

			<div class="skillbar clearfix " data-percent="70%">
				<div class="skillbar-title" style="background: #11b563;"><span>MySQL</span></div>
				<div class="skillbar-bar" style="background: #11b563;"></div>
				<div class="skill-bar-percent">70%</div>
			</div> <!-- End Skill Bar -->

				<p class="p1">Conocimientos Linux, comandos consola, sistemas de ficheros, gestión de fichero, gestión de procesos y memoria, comunicación entre procesos y núcleo SO (kernel).</p>
			<!-- //Skills -->
			</div>
			<div class="clearfix"></div>
		</div>

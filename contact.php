...
<div class="contact" id="contact">
	<div class="container">
		...
		<div class="col-md-6 contact-left">
			<h3 data-aos="zoom-in" >Contáctame</h3>
				<p> Puedes contactarme por medio de este formulario.</p>
		...
		<div class="col-md-6 contact-right">
			...
			<h4>Email</h4>
			<p><a href="mailto:amorescarlos93@hotmail.com">amorescarlos93@hotmail.com</a></p>
			</div>
			<div class="clearfix"></div>
			<ul class="top-links">
